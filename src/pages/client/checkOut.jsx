...
export default function CheckoutPage(){
    const location = useLocation()//it use get the data send from cart
    ...
    function changeQty(index, qty){
        ...
        if(newQty <= 0){
            ...
            const newCart = [...cart]//use distruct=copy in cart object data and create newCart variable
            ...
            <div className="w-[400px] shadow-2xl absolute top-1 right-1 flex flex-col justify-center items-center p-1 gap-10">
                ...
                <div>
                    <input
                       ...
                       className="w-full h-[40px] px-2 rounded-lg border-gray-300 focus-outline-none focus:ring-2 focus-ring-accent"
                       value={phoneNumber}
